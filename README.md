...
<ul>
 ...
 <li>the <b>get()</b> method returns <b>false</b> if nothing was put by the key. If the key matches some value, then <b>get()</b> returns <b>true</b> and this value. If before set operation the cache size equals the maximum, then the LRU algorithm is triggered and the cache removes from itself the key that was accessed first (in <b>get()</b> or <b>set()</b>).</li>
</ul>
